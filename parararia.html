<HTML>
	<HEAD>
		...
		<script type="text/javascript" src="./js/rume-4-glo.js"></script>
		...
		<script type="text/javascript">
			...
			const Parararia = function() {
				...
				self.showMatches = function( left, right, matches, smoothDistance, edgeDistance, size, area, precision ) {
					...
					self.show3( left, right, matches, smoothDistance, edgeDistance, size, area, precision );
...
*/
	...
	<BODY>
		<canvas height="914"></canvas>
		<div></div>
		<pre></pre>
		<img id="rock" src="./images/twa-rocket/twa-rocket-tiny.jpg"></img>
	</BODY>
</HTML>
